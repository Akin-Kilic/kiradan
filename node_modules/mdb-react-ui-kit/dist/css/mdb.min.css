...
.form-control.is-valid {
  ...
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2314a44d' d='M2.3 6.73L.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
  background-repeat: no-repeat;
...
.btn-primary:focus {
  ...
  background-color: #3260ac;
  border-color: #2f5aa2;
  box-shadow: 0 0 0 .25rem rgba(88, 134, 210, .5)
}
...
.btn-secondary:focus {
  ...
  background-color: #adb3be;
  border-color: #a9afba;
  box-shadow: 0 0 0 .25rem rgba(135, 141, 151, .5)
}
...
.btn-success:focus {
  ...
  background-color: #37b268;
  border-color: #2cad5f;
  box-shadow: 0 0 0 .25rem rgba(17, 139, 65, .5)
}
...
.btn-danger:focus {
  ...
  background-color: #e1677b;
  border-color: #e05e74;
  box-shadow: 0 0 0 .25rem rgba(187, 65, 85, .5)
}
...
.btn-warning:focus {
  ...
  background-color: #e8af3d;
  border-color: #e7aa32;
  box-shadow: 0 0 0 .25rem rgba(194, 137, 23, .5)
}
...
.btn-info:focus {
  ...
  background-color: #6ebfda;
  border-color: #65bcd7;
  box-shadow: 0 0 0 .25rem rgba(71, 153, 179, .5)
}
...
.btn-light:focus {
  ...
  background-color: #fcfcfc;
  border-color: #fbfbfb;
  box-shadow: 0 0 0 .25rem rgba(213, 213, 213, .5)
}
...
.btn-dark:focus {
  ...
  background-color: #2b2626;
  border-color: #292424;
  box-shadow: 0 0 0 .25rem rgba(82, 77, 77, .5)
}
...
.btn-outline-primary:focus {
  box-shadow: 0 0 0 .25rem rgba(59, 113, 202, .5)
}
...
.btn-outline-secondary:focus {
  box-shadow: 0 0 0 .25rem rgba(159, 166, 178, .5)
}
...
.btn-outline-success:focus {
  box-shadow: 0 0 0 .25rem rgba(20, 164, 77, .5)
}
...
.btn-outline-danger:focus {
  box-shadow: 0 0 0 .25rem rgba(220, 76, 100, .5)
}
...
.btn-outline-warning:focus {
  box-shadow: 0 0 0 .25rem rgba(228, 161, 27, .5)
}
...
.btn-outline-info:focus {
  box-shadow: 0 0 0 .25rem rgba(84, 180, 211, .5)
}
...
.btn-outline-light:focus {
  box-shadow: 0 0 0 .25rem rgba(251, 251, 251, .5)
}
...
.btn-outline-dark:focus {
  box-shadow: 0 0 0 .25rem rgba(51, 45, 45, .5)
}
...
.accordion-button:not(.collapsed)::after {
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%233b71ca'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
...
.shadow-1 {
  box-shadow: 0 0px 2px 0 rgba(0, 0, 0, .07), 0 1px 1px 0 rgba(0, 0, 0, .04) !important
}

.shadow-2 {
  box-shadow: 0 0px 3px 0 rgba(0, 0, 0, .07), 0 2px 2px 0 rgba(0, 0, 0, .04) !important
}
...
.shadow-1-strong {
  box-shadow: 0 0px 2px 0 rgba(0, 0, 0, .16), 0 1px 1px 0 rgba(0, 0, 0, .1) !important
}

.shadow-2-strong {
  box-shadow: 0 0px 3px 0 rgba(0, 0, 0, .16), 0 2px 2px 0 rgba(0, 0, 0, .1) !important
}
...
.bg-primary {
  background-color: rgba(59, 113, 202, var(--mdb-bg-opacity)) !important
}
...
.bg-success {
  background-color: rgba(20, 164, 77, var(--mdb-bg-opacity)) !important
}
...
.bg-warning {
  background-color: rgba(228, 161, 27, var(--mdb-bg-opacity)) !important
}

.bg-info {
  background-color: rgba(84, 180, 211, var(--mdb-bg-opacity)) !important
}
...
.form-switch .form-check-input:focus:before {
  box-shadow: 3px -1px 0px 13px rgba(0, 0, 0, .6);
  transform: scale(1);
  transition: box-shadow .2s, transform .2s
}
...
.btn-light.focus {
  background-color: #eee;
  color: #4f4f4f;
  box-shadow: 0 8px 9px -4px rgba(251, 251, 251, .3), 0 4px 18px 0 rgba(251, 251, 251, .2)
}
...
.btn-outline-primary:hover {
  color: #3b71ca;
  background-color: rgba(59, 113, 202, .02)
}
...
.btn-outline-secondary:hover {
  color: #285192;
  background-color: rgba(227, 235, 247, .02)
}
...
.btn-outline-danger:hover {
  color: #dc4c64;
  background-color: rgba(220, 76, 100, .02)
}
...
.btn-outline-warning:hover {
  color: #e4a11b;
  background-color: rgba(228, 161, 27, .02)
}
...
.btn-outline-info:hover {
  color: #54b4d3;
  background-color: rgba(84, 180, 211, .02)
}
...
.btn-outline-light:hover {
  color: #fbfbfb;
  background-color: rgba(251, 251, 251, .02)
}
...
.btn-outline-dark:hover {
  color: #332d2d;
  background-color: rgba(51, 45, 45, .02)
}
...
.nav-pills.menu-sidebar .show>.nav-link {
  ...
  color: #3b71ca;
  font-weight: 600;
  border-left: .125rem solid #3b71ca;
  border-radius: 0
}
...
.ripple-wave {
  ...
  touch-action: none;
  transform: scale(0);
  transition: transform cubic-bezier(0, 0, 0.15, 1), opacity cubic-bezier(0, 0, 0.15, 1);
  z-index: 999
}
